...
from bank_information import schemas,models
import jsonschema
...
def create(request:schemas.bank,db:Session):
    h=models.Bank(paynet_merchant_id=request.paynet_merchant_id,account_number=request.account_number,
                  ...
                  bank_info=request.bank_info,bank_stmt_url=request.bank_stmt_url,status=request.status,created_at=datetime.datetime.now())
